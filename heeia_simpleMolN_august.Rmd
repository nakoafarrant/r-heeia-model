---
title: "heeia_simpleMolN_august"
author: "Nakoa Farrant"
date: "8/11/2020"
output: html_document
---

Implementing the simple model from heeia april tests.Rmd into mol N/m^3 primarily rather than g/m^3
...
```{r}
solveFish <- function(pars, times = seq(0, 500, by = 1/365/4)) {
...
out_restored_new <- solveFish(pars = pars_restored)
out_urban_new <- solveFish(pars = pars_urban)
```


took about an hour to run all three for 1500 years with 6 hour time step
