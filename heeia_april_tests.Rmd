...
Na_ocean = 0.002 # also maybe a little high. Some data from Kaneohe bay indicates 0.002. Used to be 0.04 in the model
Ni_ocean = 0.005 # this may even be a little high relative to the bay being closer to 0.005 g/m^3. Used to be 0.02
...
# start running from here to visualize ammonium and nitrate modeled with the data
```{r, message=FALSE}
